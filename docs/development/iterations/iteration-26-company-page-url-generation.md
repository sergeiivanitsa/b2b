...
Статус: `MERGED`. Решения владельца A1/B1/C1 зафиксированы 2026-08-31;
реализация объединена в `main` через PR #168 squash-коммитом
`fee268c7b60cf760d296111273ead7fbf47b4af3` 2026-09-01.

...
vi.mock('../pages/CompanyReportLabPage', () => ({ CompanyReportLabPage: () => <h1>Company report lab page</h1> }))
...
describe('company page route', () => {
  ...
  it.each([
    '/company-lab/h1/7736207543-ooo-yandeks',
    '/company-lab/h2/7736207543-ooo-yandeks/legal',
    '/company-lab/h3/7736207543-ooo-yandeks/profile',
  ])('renders the noindex lab route publicly at %s', (path) => {
    mockedUseAuth.mockReturnValue(auth('anonymous'))
    render(<MemoryRouter initialEntries={[path]}><AppRouter /></MemoryRouter>)
    expect(screen.getByRole('heading', { name: 'Company report lab page' })).toBeTruthy()

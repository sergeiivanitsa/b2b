...
export function CompanyPublicH2Page({ dto }: { dto: CompanyPublicH2 }) {
  ...
  return <>
    ...
    <section id="finance"><h2>Финансы</h2><h3>Покрытие</h3><ul>{['finance_f1', 'finance_f2', 'finance_f3', 'finance_f4', 'finance_f5'].map(id => <CoverageRow item={coverageById(coverage, id)} key={id} />)}</ul><BlockSurface blocks={blocks} prefix="finance" /></section>
    ...
    <div className="company-public-h2__cta-reserver" inert aria-hidden="true"/><p className="company-public-h2__live" aria-live="polite"/>
  </>
}

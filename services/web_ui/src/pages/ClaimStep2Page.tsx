      ...
      if (uploadedCount > 0) {
        ...
        setNotice(
          uploadedCount === 1
            ...
            : `Добавлено файлов: ${uploadedCount}.`,
        )
      }
            ...
            <section className="claims-file-upload">
              ...
              <div className="claims-file-upload__form">
                ...
                <p className="claims-file-upload__hint">
                  Допустимые форматы файлов: PDF, DOC, DOCX, RTF, JPG, JPEG, PNG. Максимальный размер файла: {MAX_UPLOAD_FILE_SIZE_MB} MB.
                </p>
                {isUploading ? (
                  <p className="claims-file-upload__status">
                    {uploadProgressText ?? 'Загружаем файл...'}
                  </p>
                ) : null}
              </div>
              {files.length > 0 ? (

...
foreach ($needle in @('proxy_intercept_errors on;', 'error_page 404 = @company_h1_spa;', 'location @company_h1_spa', 'location ^~ /assets/company-public-h2.', 'root /var/lib/pork/company-public-h2/v1;', 'try_files $uri =404;', 'location = /robots.txt', 'location = /sitemaps/index.xml')) {
